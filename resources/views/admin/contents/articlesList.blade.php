...
@section('content')
    ...
    <div class="search-header">
        {!! Form::open(['url' => '/admin/articles', 'method' => 'GET', 'class' => 'form-inline', 'role' => 'form']) !!}
            ...
            @foreach($articles as $article)
                <tr class="{{ $article -> weight < 1000 ? 'stick-article success' : '' }}">
                    ...
                    <td class="edit-action {{ $article -> weight < 1000 ? 'stickMark' : '' }}">
                        ...
                        @else
                            <a href="/admin/articles/un-stick/{{ $article -> id }}" title="取消置顶"><i class="fa fa-times" aria-hidden="true"></i></a>
                        @endif
                        <a href="/admin/articles/edit/{{ $article -> id }}" title="编辑"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                        <a href="/admin/articles/delete/{{ $article -> id }}" title="删除"><i class="fa fa-trash" aria-hidden="true"></i></a>
                    </td>
                </tr>
            @endforeach
        </tbody>
    ...
    <div class="modal fade" id="stickArticleWeight" tabindex="-1" role="dialog" aria-labelledby="stickArticleWeightLabel">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                {!! Form::open(['url' => '/admin/articles/stick', 'method' => 'post', 'class' => 'form-horizontal', 'role' => 'form']) !!}
                    <!-- class include {'form-horizontal'|'form-inline'} -->
